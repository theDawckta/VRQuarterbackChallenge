...
#region Unity Messages
	...
	private void Update()
	{
		...
		if (enableAdaptiveResolution)
		{
            ...
            float minViewportScale = minRenderScale / XRSettings.eyeTextureResolutionScale;
            float recommendedViewportScale = OVRPlugin.GetEyeRecommendedResolutionScale() / XRSettings.eyeTextureResolutionScale;
            recommendedViewportScale = Mathf.Clamp(recommendedViewportScale, minViewportScale, 1.0f);
            XRSettings.renderViewportScale = recommendedViewportScale;
        }
#endif
