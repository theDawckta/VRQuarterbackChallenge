...
namespace CurvedVRKeyboard {
    ...
    public class KeyboardStatus: KeyboardComponent {
        ...
        private void BackspaceKey () {
            if(targetGameObject.GetComponent<TextMeshPro>().text.Length >= 1) {
                targetGameObject.GetComponent<TextMeshPro>().text = targetGameObject.GetComponent<TextMeshPro>().text.Substring(0, (targetGameObject.GetComponent<TextMeshPro>().text.Length - 1));
        ...
        private void TypeKey ( char key ) {
            if(targetGameObject.GetComponent<TextMeshPro>().text.Length < maxOutputLength) {
                targetGameObject.GetComponent<TextMeshPro>().text = targetGameObject.GetComponent<TextMeshPro>().text + key.ToString();
